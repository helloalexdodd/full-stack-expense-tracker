<template>
  <form @submit.prevent="addTransaction({transaction, type: 'expense'})" action="POST" class="my-5">
    <legend class="mb-3 py-2">Add a new expense</legend>
    ...
    <b-field label="Amount" for="amount" :message="amountValidation" :type="amountInvalid">
      <b-input
        ...
        @blur="$emit('convert-to-currency', transaction.amout)"
    ...
    <b-button native-type="submit" class="is-success has-text-weight-bold">Submit Expense</b-button>
  </form>
</template>
